...
public class ProfileM extends AppCompatActivity {
    ...
    EditText name, colname, empcode, dept;
    FirebaseAuth mAuth;
    Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        empcode = findViewById(R.id.texte);
        dept = findViewById(R.id.textd);
        save = findViewById(R.id.saveb);
        progressBar = findViewById(R.id.progressBar);
        db = FirebaseDatabase.getInstance().getReference("Users_Prof");
            ...
            public void onClick(View v) {
                ...
                if (firebaseUser != null) {
                    ...
                    if (empnumber.isEmpty()) {
                        empcode.setError("Field should not be empty");
                    ...
                    progressBar.setVisibility(View.VISIBLE);
                    final ProfileDatabase profileDatabase = new ProfileDatabase(displayname, college_name, empnumber, dept_name, "", picurl);
                    db.child(uid).setValue(profileDatabase).addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                ...
                                Intent intent = new Intent(ProfileM.this, MainActivity.class);
